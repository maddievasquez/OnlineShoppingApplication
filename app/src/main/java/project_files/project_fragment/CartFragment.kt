...
import com.dorset_22773_madelin_vasquez.project_files.databinding.FragmentCartBinding
...
class CartFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = ItemListAdapter("CartFragment", ItemListener {
        ...
        binding.checkout.setOnClickListener {
            ...
            val builder = NotificationCompat.Builder(requireActivity(), "My_Notification_Channel")
                .setSmallIcon(R.drawable.ic_shopping_cart_checkout)
